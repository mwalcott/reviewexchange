...
<div id="content" class="widecolumn container text-center">
    ...
    <?php } else {
        ...
        if ( is_wp_error($result) ) {
            if ( 'already_active' == $result->get_error_code() || 'blog_taken' == $result->get_error_code() ) {
                ...
                ?>
                <h2><?php _e('Congratulations your account is now active. See below for more inforamtion.'); ?></h2>
                <?php
            ...
            <div id="signup-welcome">
                <p><?php _e('Username:'); ?> <?php echo $user->user_login ?></p>
            </div>
            ...
            <?php else: ?>
                <p class="view"><?php printf( __('Your account is now activated. <a href="/my-account">Log in</a> or go back to the <a href="%2$s">homepage</a>.' ), network_site_url('wp-login.php', 'login'), network_home_url() ); ?></p>
            <?php endif;
        }
    }
    ?>
