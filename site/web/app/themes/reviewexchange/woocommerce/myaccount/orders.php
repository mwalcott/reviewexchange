...
<?php the_field('my_matches_content', 'option'); ?>
...
<?php else : ?>
	<div class="woocommerce-Message woocommerce-Message--info woocommerce-info">
		<?php _e( 'You haven’t asked for a reviewer match for your book yet.', 'woocommerce' ); ?>
	</div>
	<a href="/product/request-a-match/" class="btn btn-primary btn-lg">Request A Match</a>
<?php endif; ?>
